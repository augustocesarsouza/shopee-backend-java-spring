...
public class AddressCreateDTOValidator {
    @JsonProperty("id")
    private String Id;
    ...
    public AddressCreateDTOValidator(String fullName, String phoneNumber, String cep, String stateCity, String neighborhood, String street, String numberHome,
                                     Byte saveAs) {
        FullName = fullName;
